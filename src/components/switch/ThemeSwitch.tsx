  ...
  return (
    ...
    >
      <button
        ...
        } shrink-0 flex justify-center items-center gap-4 duration-500`}
      >
      ...
      >
        <div className={`fully-center ${isCollapsed ? 'translate-x-2' : ''} duration-500`}>
          <MoonIcon
        ...
        <span className={` duration-500 ${isCollapsed ? "text-[0rem] scale-0 opacity-0" : "opacity-100"} `}>
          {isDark ? "Dark" : "Light"}
        </span>
      </button>
      <span
